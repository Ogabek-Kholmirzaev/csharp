...
WriteLine($"1st dimension, upper bound: {grid1.GetUpperBound(0)}"); // Row
WriteLine($"2nd dimension, lower bound: {grid1.GetLowerBound(1)}");
WriteLine($"2nd dimension, upper bound: {grid1.GetUpperBound(1)}"); // Column
